...
$user_id_auth = rtrim(ltrim($_POST['user_id_auth'])); // removed extra spaces

$pass_key = rtrim(ltrim($_POST['pass_key']));


$user_id_auth = stripslashes($user_id_auth); // removed qupteds incase string is quoted
