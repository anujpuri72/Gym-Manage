<!-- file to show overview of members per month -->
<?php
...
<head>
	...
	<title>GOLD'S Gym | Member per month</title>
	...
	<div class="page-container sidebar-collapsed" id="navbarcollapse">
		...
		<div class="main-content">
			...
			<form>
				...
				<input type="button" class="a1-btn a1-green" style="margin-bottom:5px;" name="search" onclick="showMember();" value="Search">
