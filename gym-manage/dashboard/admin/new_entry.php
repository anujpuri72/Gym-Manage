...
<head>
	...
	<title>GOLD'S Gym | New User</title>
								...
								<td height="35">
									<table width="100%" border="0" align="center">
										...
										<tr>
											...
											<td height="35"><select name="plan" id="boxx">
													<option value="">--Please Select--</option>
													<?php
										...
										<tr>
											<td height="35">&nbsp;</td>
											<td height="35"><input class="a1-btn a1-green" type="submit" name="submit" id="submit" value="Register">
